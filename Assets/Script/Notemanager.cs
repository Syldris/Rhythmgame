...
public class Notemanager : MonoBehaviour
{
    ...
    IEnumerator Note_Ins()
    {
        while (true)
        {
            ...
            {
                Judgment_Line_Objects[0].GetComponent<judgement_line>().NoteClick = false;
            }
            ...
            {
                Judgment_Line_Objects[1].GetComponent<judgement_line>().NoteClick = false;
            }
            ...
            {
                Judgment_Line_Objects[2].GetComponent<judgement_line>().NoteClick = false;
            }
            ...
            {
                Judgment_Line_Objects[3].GetComponent<judgement_line>().NoteClick = false;
            }
            ...
            {
                Judgment_Line_Objects[4].GetComponent<judgement_line>().NoteClick = false;
            }
            ...
            {
                Judgment_Line_Objects[5].GetComponent<judgement_line>().NoteClick = false;
            }
            yield return null;
        }
    }
